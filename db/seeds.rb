...
Task.delete_all
Task.create!(subject:"Rocket Scanner", description:"Assemble a scanner.",due_date:"2015-01-30", status:true, priority: "high", group_id: 1)
Task.create!(subject:"Carry Cart",  description:"Complete plastic carrying cart", due_date:"2015-03-21", status:false, priority: "high", group_id: 1)
Task.create!(subject:"Wireless Protocol", description:"Complete wireless for rocket scanner", due_date:"2015-03-21", status:false, priority: "high", group_id: 2)
Task.create!(subject:"Rocket Scanner Testing",  description:"Assemble a scanner.", due_date:"2015-03-30", status:true, priority: "high", group_id: 3)
Task.create!(subject:"Wing Cleaner Mechanicals",  description:"Design/fabricate the wing cleaner mechanicals.", due_date:"2015-01-30", status:false, priority: "high", group_id: 4)
Task.create!(subject:"Self-automation electronics",  description:"FPGA design for self-automated object", due_date:"2015-03-21", status:true, priority: "high", group_id: 5)
Task.create!(subject:"On-ground test",  description:"On-site test at a randomn AFB.", due_date:"2015-03-21", status:false, priority: "high", group_id: 5)
Task.create!(subject:"Pot Hole Fixer",  description:"Automatic pot hole fixer.",due_date:"2015-03-30", status:true, priority: "low", group_id: 6)
