...
Task.create!(subject:"Wing Cleaner Mechanicals",  description:"Design/fabricate the wing cleaner mechanicals.", due_date:"2015-01-30", complete:false, priority: "Medium", group_id: 4)
...
Task.create!(subject:"On-ground test",  description:"On-site test at a randomn AFB.", due_date:"2015-03-21", complete:false, priority: "Medium", group_id: 5)
